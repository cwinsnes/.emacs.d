...
*** DIRED
Creates a function for creating a new file in DIRED.
#+BEGIN_SRC emacs-lisp
...
Bind it to '_' to make it right next to '+' which is the command for new directory.
#+BEGIN_SRC emacs-lisp
(define-key dired-mode-map (kbd "_") 'my-dired-create-file)
(evil-define-key 'normal dired-mode-map (kbd "_") 'my-dired-create-file)
#+END_SRC
*** Autocompleting
#+BEGIN_SRC emacs-lisp
